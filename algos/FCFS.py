...
class FCFS(ProcessSim):
    ...
    def __init__(self, pid, arrv_time, burst_time, comp_time, wait_time=0, turn_around_time=0, response_time=0):
        """
    ...
    def get_current_params(self):
        return self.wait_time, self.turn_around_time, self.response_time
